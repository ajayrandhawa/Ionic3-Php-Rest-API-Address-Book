...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@angular/core", "@angular/forms", "../action-sheet/action-sheet", "../alert/alert", "../popover/popover", "../app/app", "../../config/config", "../../navigation/deep-linker", "../../util/form", "../../util/base-input", "../../util/util", "../item/item", "../../navigation/nav-controller", "../option/option", "./select-popover-component"], factory);
    }
    ...
    var Select = (function (_super) {
         ...
         * @param {?} deepLinker
         */
        function Select(_app, form, config, elementRef, renderer, item, _nav, deepLinker) {
        ...
        Select.prototype.open = function (ev) {
            ...
            this._fireFocus();
            overlay.onDidDismiss(function (value) {
                _this._fireBlur();
                if (_this.interface === 'popover' && value) {
                    _this.value = value;
                    _this.ionChange.emit(value);
                }
            });
        };
