import { AfterContentInit, NgZone, ChangeDetectorRef, ElementRef, OnDestroy, Renderer } from '@angular/core';
...
export declare class Toggle extends BaseInput<boolean> implements IonicTapInput, AfterContentInit, OnDestroy {
     ...
     */
    checked: boolean;
    constructor(form: Form, config: Config, _plt: Platform, elementRef: ElementRef, renderer: Renderer, _haptic: Haptic, item: Item, _gestureCtrl: GestureController, _domCtrl: DomController, _cd: ChangeDetectorRef, _zone: NgZone);
    /**
     * @hidden
     */
