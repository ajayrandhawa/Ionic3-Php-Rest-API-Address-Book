...
var MockElement = (function () {
     ...
     * @return {?}
     */
    MockElement.prototype.addEventListener = function (type, listener, options) { };
    /**
     * @param {?} type
     * @param {?} listener
     * @param {?=} options
     * @return {?}
     */
    MockElement.prototype.removeEventListener = function (type, listener, options) { };
    /**
     * @param {?} name
     * @return {?}
     */
...
export function mockNavController() {
    ...
    var /** @type {?} */ nav = new NavControllerBase(null, app, config, platform, keyboard, elementRef, zone, renderer, componentFactoryResolver, gestureCtrl, trnsCtrl, linker, dom, null);
...
export function mockTab(parentTabs) {
    ...
    var /** @type {?} */ gestureCtrl = new GestureController(app);
    var /** @type {?} */ linker = mockDeepLinker(null, app);
    var /** @type {?} */ tab = new Tab(parentTabs, app, config, platform, keyboard, elementRef, zone, renderer, compiler, changeDetectorRef, gestureCtrl, null, linker, dom, null);
...
export function mockOverlay() {
    return {
        present: function (opts) { return Promise.resolve(); },
        dismiss: function (data, role, navOptions) { return Promise.resolve(); },
