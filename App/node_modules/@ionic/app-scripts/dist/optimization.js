...
function purgeUnusedImports(context, purgeDependencyMap) {
    ...
    var updatedFileContent = treeshake_1.purgeUnusedImportsAndExportsFromIndex(moduleFilePath, moduleFile.content, modulesToPurge);
    context.fileCache.set(moduleFilePath, { path: moduleFilePath, content: updatedFileContent });
    attemptToPurgeUnusedProvider(context, purgeDependencyMap, helpers_1.getStringPropertyValue(Constants.ENV_ACTION_SHEET_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_ACTION_SHEET_VIEW_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_ACTION_SHEET_COMPONENT_FACTORY_PATH), helpers_1.getStringPropertyValue(Constants.ENV_ACTION_SHEET_CONTROLLER_CLASSNAME));
    attemptToPurgeUnusedProvider(context, purgeDependencyMap, helpers_1.getStringPropertyValue(Constants.ENV_ALERT_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_ALERT_VIEW_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_ALERT_COMPONENT_FACTORY_PATH), helpers_1.getStringPropertyValue(Constants.ENV_ALERT_CONTROLLER_CLASSNAME));
    attemptToPurgeUnusedProvider(context, purgeDependencyMap, helpers_1.getStringPropertyValue(Constants.ENV_LOADING_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_LOADING_VIEW_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_LOADING_COMPONENT_FACTORY_PATH), helpers_1.getStringPropertyValue(Constants.ENV_LOADING_CONTROLLER_CLASSNAME));
    attemptToPurgeUnusedProvider(context, purgeDependencyMap, helpers_1.getStringPropertyValue(Constants.ENV_MODAL_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_MODAL_VIEW_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_MODAL_COMPONENT_FACTORY_PATH), helpers_1.getStringPropertyValue(Constants.ENV_MODAL_CONTROLLER_CLASSNAME));
    attemptToPurgeUnusedProvider(context, purgeDependencyMap, helpers_1.getStringPropertyValue(Constants.ENV_PICKER_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_PICKER_VIEW_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_PICKER_COMPONENT_FACTORY_PATH), helpers_1.getStringPropertyValue(Constants.ENV_PICKER_CONTROLLER_CLASSNAME));
    attemptToPurgeUnusedProvider(context, purgeDependencyMap, helpers_1.getStringPropertyValue(Constants.ENV_POPOVER_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_POPOVER_VIEW_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_POPOVER_COMPONENT_FACTORY_PATH), helpers_1.getStringPropertyValue(Constants.ENV_POPOVER_CONTROLLER_CLASSNAME));
    attemptToPurgeUnusedProvider(context, purgeDependencyMap, helpers_1.getStringPropertyValue(Constants.ENV_TOAST_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_TOAST_VIEW_CONTROLLER_PATH), helpers_1.getStringPropertyValue(Constants.ENV_TOAST_COMPONENT_FACTORY_PATH), helpers_1.getStringPropertyValue(Constants.ENV_TOAST_CONTROLLER_CLASSNAME));
}
