...
var baseDir = path_1.join(process.cwd(), 'some', 'dir', 'myApp');
var srcDir = path_1.join(baseDir, 'src');
var main = path_1.join(srcDir, 'app', 'main.js');
var appModule = path_1.join(srcDir, 'app', 'app.module.js');
var nodeModulesDir = path_1.join(baseDir, 'node_modules');
var ionicAngularDir = path_1.join(nodeModulesDir, 'ionic-angular');
var ionicAngularEntryPoint = path_1.join(ionicAngularDir, 'index.js');
var ionicAngularModuleFile = path_1.join(ionicAngularDir, 'module.js');
var componentDir = path_1.join(ionicAngularDir, 'components');
describe('treeshake', function () {
    ...
    describe('calculateTreeShakeResults', function () {
        it('should remove modules that are only imported by the module file', function () {
            // arrange
            var dependencyOne = path_1.join(componentDir, 'range.js');
            var dependencyTwo = path_1.join(componentDir, 'radio-button.js');
            var dependencyThree = path_1.join(componentDir, 'check-box.js');
            ...
            var dependencySetModule = new Set();
            ...
            dependencyMap.set(ionicAngularEntryPoint, new Set());
            // act
        ...
        it('should remove other components that are imported only by module file or other modules that can be removed (only imported by module file)', function () {
            // arrange
            var dependencyOne = path_1.join(componentDir, 'range.js');
            var dependencyOneNgFactory = path_1.join(componentDir, 'range.ngfactory.js');
            var dependencyOneHelperOne = path_1.join(componentDir, 'range', 'helperOne.js');
            var dependencyOneHelperTwo = path_1.join(componentDir, 'range', 'helperTwo.js');
            var dependencyTwo = path_1.join(componentDir, 'radio-button.js');
            var dependencyThree = path_1.join(componentDir, 'check-box.js');
            var dependencyFour = path_1.join(componentDir, 'badge.js');
            var dependencyFourNgFactory = path_1.join(componentDir, 'badge.ngfactory.js');
            var appModuleNgFactory = path_1.join(srcDir, 'app', 'app.module.ngfactory.js');
            var alert = path_1.join(componentDir, 'alert', 'alert.js');
            var alertController = path_1.join(componentDir, 'alert', 'alert-controller.js');
            var alertComponent = path_1.join(componentDir, 'alert', 'alert-component.js');
            var alertComponentNgFactory = path_1.join(componentDir, 'alert', 'alert-component.ngfactory.js');
            var actionSheet = path_1.join(componentDir, 'action-sheet', 'action-sheet.js');
            var actionSheetController = path_1.join(componentDir, 'action-sheet', 'action-sheet-controller.js');
            var actionSheetComponent = path_1.join(componentDir, 'action-sheet', 'action-sheet-component.js');
            var actionSheetComponentNgFactory = path_1.join(componentDir, 'action-sheet', 'action-sheet-component.ngfactory.js');
            var home = path_1.join(srcDir, 'pages', 'home.js');
            var homeNgFactory = path_1.join(srcDir, 'pages', 'home.ngfactory.js');
    ...
    describe('purgeComponentNgFactoryImportAndUsage', function () {
        it('should purge the component factory import and usage from the file', function () {
            ...
            var appModuleNgFactoryPath = path_1.join(srcDir, 'app', 'app.module.ngfactory.js');
            var componentFactoryPath = path_1.join(componentDir, 'action-sheet', 'action-sheet-component.ngfactory.js');
            var componentFactoryPath2 = path_1.join(componentDir, 'alert', 'alert-component.ngfactory.js');
            // act
    ...
    describe('purgeProviderControllerImportAndUsage', function () {
        it('should purge the controller provider content', function () {
            ...
            var appModuleNgFactoryPath = path_1.join(srcDir, 'app', 'app.module.ngfactory.js');
            var controllerPath = path_1.join(componentDir, 'action-sheet', 'action-sheet-controller.js');
            var controllerPath2 = path_1.join(componentDir, 'alert', 'alert-controller.js');
            // act
            ...
            var relativeImportPathOne = helpers.toUnixPath(helpers.changeExtension(path_1.relative(nodeModulesDir, controllerPath), ''));
            var relativeImportPathTwo = helpers.toUnixPath(helpers.changeExtension(path_1.relative(nodeModulesDir, controllerPath2), ''));
